...
#pragma warning disable 649
    ...
    public CategoryBtnScript[] categoryBtnPrefab;
...
#pragma warning restore 649
    ...
    void CreateCategoryButtons()
    {
        ...
        for (int i = 0; i < quizManager.QuizData.Count; i++)
        {
            ...
            categoryBtnPrefab[i].SetButton(quizManager.QuizData[i].categoryName, quizManager.QuizData[i].questions.Count);
            int index = i;
            //Add listner to button which calls CategoryBtn method
            categoryBtnPrefab[i].Btn.onClick.AddListener(() => CategoryBtn(index, quizManager.QuizData[index].categoryName));
        }
    }
